...
{
    public class MySqlInterpreterFactory : IDbInterpreterFactory
    {
        ...
        public class MySqlInterpreter : DbInterpreter
        {
            ...
            public string NotCreateIfExistsClause
            { get { return this.NotCreateIfExists ? "IF NOT EXISTS" : ""; } }
